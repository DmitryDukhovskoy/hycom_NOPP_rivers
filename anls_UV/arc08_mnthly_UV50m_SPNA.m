% subsample monthly fileds 50m UV into SPNA
% for Igor Yashayaev analysis
% see mnthly_arc08_UV50m.m
%
...
fprintf('Monthly mean UV %i-%i in the layer: %i- %im\n',YR1,YR2,zz1,zz2);
...
Vmn=[];
for iyr=YR1:YR2
		fmatin = sprintf('%smnthUV_%4.4i-%4.4i_%i.mat',pthmat,abs(zz1),abs(zz2),iyr);
...
fmatout = sprintf('%sarc08_mnthUVspna50m_%i-%i.mat',pthmat,YR1,YR2);
fprintf('Saving %s\n',fmatout);
save(fmatout,'UV');
