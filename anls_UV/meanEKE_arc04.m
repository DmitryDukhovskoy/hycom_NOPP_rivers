% HYCOM 0.04 resolution simulation
% Plot monthly mean UV fields
% derived in mnthly_arc04_UV50m.m
...
% Annual means:
  ...
  for iday=1:dday:365
    ...
    pthbin = sprintf('/nexsan/hycom/ARCc0.04_%3.3i/data/%4.4i/',expt,iyr);
...
% should be 1/2*rhow*(mean(dU^2)+mean(dV^2)) !!!
  ...
  EKE.Title='Annual mean EKE from HYCOM-CICE 0.08-110, ~50m averg U';
