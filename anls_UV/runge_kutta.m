...
%  Do not use NaNs in the U,V fields
%  
...
% 1) Find angle between two vectors: local North direction and vertical
%    orientation in the figure
%disp('Rotating U, V to X,Y grid ...');
[m,n]=size(U1);
