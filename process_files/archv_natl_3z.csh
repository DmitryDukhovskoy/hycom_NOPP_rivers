...
while ($d1 < 2)
    ...
    setenv FOR072A ${O}/hycom008_110z_NAtl_${YY}-${d}_t.a
    setenv FOR072  ${O}/hycom008_110z_NAtl_${YY}-${d}_t.b
    setenv FOR071A ${O}/hycom008_110z_NAtl_${YY}-${d}_s.a
    setenv FOR071  ${O}/hycom008_110z_NAtl_${YY}-${d}_s.b
#    set ARR = (CDF033 CDF034 CDF037 CDF 038)
#    /bin/rm -f $CDF033.bin  $CDF034.bin $CDF037.bin  $CDF038.bin 
    /bin/rm -f $FOR071A $FOR072A 
    /bin/rm -f $FOR071  $FOR072
...
HYCOM
 ...
 380    'iorign' = i-origin of plotted subregion
  10    'jorign' = j-origin of plotted subregion
 715    'idmp  ' = i-extent of plotted subregion (<=idm; 0 implies idm)
 1115   'jdmp  ' = j-extent of plotted subregion (<=jdm; 0 implies jdm)
 ...
 6000.0  'z     ' = sample depth 55
  ...
  72    'temio ' = temperature I/O unit (0 no I/O)
  71    'salio ' = salinity    I/O unit (0 no I/O)
