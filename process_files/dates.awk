...
# with dDay intervals
# 
# Usage: echo "DATES" | awk -f dates.awk y01=098 d01=1,...,366
...
#
#       echo "MM2AB" | awk -f dates.awk MM=5
#       converts months (1,2,...12) to HYCOM a,b,c,...
#
...
/^MM2AB/ {
  ...
  MM = MM + 0 # to force conversion srting->number
  AB = M[MM]
  printf(" %s\n",AB)
}
...
#
# echo "YRMO START DAY" | awk -f 103dates.awk y01=097 MM=04 dd=7
