% This is an obsolete code - may be ok as long as it uses updated collocation code - double check
% use greenl_fluxes_POPboxes.m - accurate vol flux calculation
...
ZZf = [(0:-2:-12)';(-15:-5:-50)';(-50:-10:-100)';...
       (-125:-25:-150)';(-200:-50:-400)';(-500:-100:-1000)';(-1250:-250:-5000)'];
kzz = length(ZZf);
