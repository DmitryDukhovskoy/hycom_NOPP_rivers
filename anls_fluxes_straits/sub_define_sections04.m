function SCT = sub_define_sections04(HH,LON,LAT);
%
%
...
IJf=load(fmt); % Fram - close to moorings
SCT(3).IJ=[908  904; ...
           1083 939]*2;
IJf.Isct=IJf.Isct*2;
IJf.Jsct=IJf.Jsct*2;
%SCT(3).IJ=[IJf.Isct(1) IJf.Jsct(1); ...
%           IJf.Isct(end) IJf.Jsct(end)];

SCT(3).IJ=[IJf.Isct IJf.Jsct];
