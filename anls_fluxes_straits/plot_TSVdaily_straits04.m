% Plot fluxes 
% extracted data are in extr_TSVdaily_straits04.m
...
axes('Position',ps);
hold on;
plot(dTM, VFlx, '-','Linewidth',2)
plot(dTM, VFlx,'.','Markersize',16)
set(gca,'tickdir','out',...
        'xlim',[dTM(1) dTM(end)],...
        'ylim',[-18 12],...
        'xtick',[0:30:365],...
        ...
        'Fontsize',12);
mnVFlx = nanmean(VFlx);
stl=sprintf('0.04 HYCOM-%3.3i, VolFlx, mean=%5.2f Sv, %s, %i-%i',expt,mnVFlx,sct_name,YR1,YR2);
title(stl);
...
set(gca,'tickdir','out',...
        ...
        'ygrid','on',...
        'Fontsize',12);
stl=sprintf('HYCOM 0.04-012, VolF, Sv, %s, %i-%i',sct_name,YR1,YR2);
title(stl);
Vmn=nanmean(mVflx);
...
set(gca,'tickdir','out',...
        ...
        'ygrid','on',...
        'Fontsize',12);
stl=sprintf('HYCOM 0.04-012, HeatF (T=%3.1fC), TW, %s, %i-%i',Tref1,sct_name,YR1,YR2);
title(stl);
Hmn=nanmean(mHF1);
...
set(gca,'tickdir','out',...
        ...
        'ygrid','on',...
        'Fontsize',12);
stl=sprintf('HYCOM 0.04-012, HeatF (T=%3.1fC), TW, BSO, %i-%i',Tref2,YR1,YR2);
title(stl);
Hmn=nanmean(mHF2);
...
set(gca,'tickdir','out',...
        ...
        'ygrid','on',...
        'Fontsize',12);
stl=sprintf('HYCOM 0.04-012, FWFlx (%5.2f), mSv, BSO, %i-%i',Sref1,YR1,YR2);
title(stl);
Fmn=nanmean(mFW1);
...
set(gca,'tickdir','out',...
        ...
        'ygrid','on',...
        'Fontsize',12);
stl=sprintf('HYCOM 0.04-012, FWFlx (%5.2f), mSv, BSO, %i-%i',Sref2,YR1,YR2);
title(stl);
Fmn=nanmean(mFW2);
...
set(gca,'tickdir','out',...
        ...
        'ygrid','on',...
        'Fontsize',12);
stl=sprintf('HYCOM 0.04-012, FWFlx (S<%5.2f), mSv, BSO, %i-%i',Sref1,YR1,YR2);
title(stl);
%Fmn=nanmean(mFW3);
...
set(gca,'tickdir','out',...
        ...
        'ylim',[yl1 yl2],...
        'Fontsize',12);
stl=sprintf('HYCOM 0.04-012, BSO, U m/s %i-%i',YR1,YR2);
...
nint= 200;
CMP = create_colormap5(nint,0,10);
cmp0= CMP.colormap;
...
stl=sprintf('HYCOM 0.04-012, BSO, S %i-%i',YR1,YR2);
title(stl,'Fontsize',12);
...
set(gca,'tickdir','out',...
        ...
        'ylim',[yl1 yl2],...
        'Fontsize',12);
stl=sprintf('HYCOM 0.04-012, T, U m/s %i-%i',YR1,YR2);
title(stl,'Fontsize',12);
