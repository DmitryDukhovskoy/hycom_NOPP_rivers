function UTS=collocate_UTS_section_OLD(I,J,U,V,T,S,dH,HH,LON,LAT,nin);
...
% going through the p-points
  if en_pn==en_pnL & pn_pnL==0  % nothing changed, keep going
    if pny==0  % horizontal segment
      j1=j0-1;
      i1=i0;
      CLC=sub_collocate2uv_OLD(V,T,S,dH,HH,i0,j0,i1,j1);
    else
      j1=j0;
      i1=i0-1;
      CLC=sub_collocate2uv_OLD(U,T,S,dH,HH,i0,j0,i1,j1);
    end
