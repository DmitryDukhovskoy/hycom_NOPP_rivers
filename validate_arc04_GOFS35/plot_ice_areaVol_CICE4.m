...
% extracted in extr_ice_areaVol_CICE4.m
%
...
fmatout = sprintf('%s008hycom_cice4_%3.3i_seaice_VolArea.mat',pthmat,expt);
...
set(gca,'tickdir','out',...
        ...
        'ygrid','on',...
        'fontsize',12);
stl = sprintf('0.08HYCOM-CICE4 expt%3.3i, %i, Sea Ice Area, km^2',expt,YR);
title(stl);
...
stl = sprintf('0.08HYCOM-CICE4 expt%3.3i, %i, Ice Vol, km^3',expt,YR);
title(stl);
