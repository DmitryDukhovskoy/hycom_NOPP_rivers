...
% extracted in extact_TS_arc04.m
...
btxt = 'plot_gofs35_arc04_TSxsct.m';
...
%  end
  ...
  stl=sprintf('ARCc0.04-%3.3i, %s, %s, %s, %i',...
...
%  end
  ...
  if s_fig>0
    fgnm=sprintf('%sarc04-%s_%s_%s_%i',pthfig,expt,sname,pfld,yr);
    fprintf('Saving %s\n',fgnm);
    print('-dpng','-r300',fgnm);
  end
