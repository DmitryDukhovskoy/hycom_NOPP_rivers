...
% 022 - GOFS3.5 CICEv5
expt = 022;  % ARCc HYCOM experiment #
...
%    pthbin='/Net/kronos/ddmitry/hycom/ARCc0.04/output/'; % test with corrected coupling
%    pthbin='/Net/kronos/ddmitry/hycom/ARCc0.04/output_0901gofs35/'; % GLBc CICE restart 0901
  end
...
%	      regn,expt,fld0,DV(1:3),xname);
  stl=sprintf('%s-%3.3i, GLBc CICE rest 0901 %s, %4.4i/%2.2i/%2.2i, %s',...
	      regn,expt,fld0,DV(1:3),xname);
  nf=1;
  xdr = 1;
  f_layer=0;
