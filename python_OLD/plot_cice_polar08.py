...
"""
pthnc = '/nexsan/people/ddmitry/hycom/ARCc0.04_022/ARCc0.08_122_{0}/{1}_cice/'.format(expt,yr)
...
flnm = '122_cice.{0}-{1:02d}-{2:02d}.nc'.format(yr,mo,mday)
...
plt.title('0.08 HYCOM-CICE, {0}, aice, {1}, {2}'.format(expt,rhl,flnm))
