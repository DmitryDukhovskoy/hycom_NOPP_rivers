...
s_fig = 0;
f_tracloc = 1; % =1 - add locations of tracer release to transect maps
rg=9806;  % convert pressure to depth, m
fld0='tracer'; %'salin' - background field
plr=0; % highlight this interface
txtb = 'ddmitry@mars:hycom_NOPP_rivers/anls_Greenland/xsection_fjords_tracers.m';
...
%  finb = sprintf('%s%s_archv.%4.4i_%3.3i_00.b',pthbin,expt,yr,iday);
  ...
  tic;
  [F,n,nlev] = read_hycom(fina,finb,fld0);
  toc;
...
% Plot:
  ...
  nf=1;
  f_layer=0;
  sub_plot_xsection(nf,XL,ZZav,lTr,stl,fld0,f_layer,xdr);
