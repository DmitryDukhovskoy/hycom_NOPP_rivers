...
btx     = 'propagation_month_timing_v1.m';
...
flcmx=sprintf('%smax_trmass_mo_lev%2.2i.mat',pthmat,ilv);
if f_maxc==1
  cc=0;
  CMX = HH*0;
%  clear sumT
...
fltmx=sprintf('%sTmax_trmass_mo_lev%2.2i_r%3.3i.mat',pthmat,ilv,rmax*100);
if f_maxt==1
  for iyr=yr1:yr2
    cc=0;
    dmm=HH*0;
