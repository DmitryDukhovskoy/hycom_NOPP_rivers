function GC = sub_greenl_isobath_arc04(HG,LON,LAT)
% Define a closed contour around Greenland
% Identical to one used for HYCOM 0.08
HH = HG;
[mm,nn]=size(HG);
...
x0 = 1448;
y0 = 1562;
fprintf('Starting point: x=%i,y=%i\n',xS,yS);
