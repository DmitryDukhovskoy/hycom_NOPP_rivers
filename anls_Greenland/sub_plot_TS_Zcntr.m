function sub_plot_TS_Zcntr(FF,ZZ,xx,nf,title_str,Hs,c1,c2,pfld);
...
% Assuming c1<0
  ...
  naC = 50;
  naB = round(naC*rcc)/2;
  cl21 = colormap_yellow(naB);
  cl22 = colormap_red(naB);
  cl1 = colormap_cold(naC);
  for ik=1:15
    cl2(ik,:) = [1 1 0.7];
  end
  cl2=[cl21;cl22];
  cl2 = smooth_colormap(cl2,20);
  cl2 = smooth_colormap(cl2,20);
  cl2 = smooth_colormap(cl2,20);
...
chb = colorbar;
set(chb,'Position',[0.92 0.3 0.012 0.6],...
	'TickLength',0.02,...
	'FontSize',14);
set(gcf,'Position',[1083 548 1390 769]);
return
