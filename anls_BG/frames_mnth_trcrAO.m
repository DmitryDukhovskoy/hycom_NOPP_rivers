% Use updated extracted tields
% Plot monthly-mean, depth-integrated 
% tracer concentrations 
% The Data are extracted in extr_MassTrcr_mnth.m
% Plotted as FWC, m3/m2
...
nlr = 1; % layer to plot from saved layer LRS.dat, 5 - whole depth
s_fig = 1;
...
pthmat  = sprintf('/Net/tholia/ddmitry/hycom/ARCc0.08/%3.3i/data_matTr/',expt);
