function Rmask = sub_Greenland_tracer_arc04(BB);
...
%
fprintf('sub_Greenland_tracer_arc04 ...\n');
...
elon     = BB.hycom_LON;
alat     = BB.hyom_LAT;
%cf       = BB.area_cf;       % mean cell area, m2, for runoff m/s->m3/sec
...
% Rivers:
flriva=sprintf('%srivers_%s_Greenland_%i.a',PTH.river,toponm,iyr);
flrivb=sprintf('%srivers_%s_Greenland_%i.b',PTH.river,toponm,iyr);
