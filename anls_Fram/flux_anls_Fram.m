...
f_plts=0;  % S
f_pltt=0;  % T
f_fwf=1;   % calc FW flux. mSv
f_vflx=1;   % calc vol flux. Sv
...
pthmat2=sprintf('/Net/ocean/ddmitry/HYCOM/ARCc/ARCc0.08/%3.3i/data_GrSect/',expt);
btx = 'flux_anls_Grshelf_Fram.m';
