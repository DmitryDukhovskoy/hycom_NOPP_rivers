...
% in fix_NCARrivers.m
%
% Use Greenland runoff based on Bamber data - new data, 1958(?) - 2016
% New grid and updated runoff data from Greenland - do not
% match older version of 2015 (1958-2010)
%
% after 2010 -2016 - Bamber data 2018
% after 2016 - no runoff/Greenland data are available
%              copy last year of river/Greenland runoff
...
for iyr=2016:2019
  ...
  year = YearGr;
  fprintf('River Runoff Year: %i, Topography: %s\n',YearGr,TV);
...
% HYCOM existing with climatology and Greenland Bamber 2015
  if iyr<=2010
...
% HYCOM climatology and no Greenland
...
%  clear GRgrd
 ...
 aa=sprintf('Yenisey,Lena,Ob,Mackenzie,Pechora,Khatanga,Kolyma,S.Dvina,Taz,Indigirka;');
    ...
    if nl==3
 aa=sprintf('Mackenzie,Olenek,Yana,Mezen,Onega,Anabar,Pyasina,Anderson,Kobuk;');
    end
    if nl==4
