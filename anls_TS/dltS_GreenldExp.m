...
%
% !!!!!!!!!!!!!!!!!!
% This code has problems - use dltS_zlv_GreenldExp
%
...
YRPLT=[];
cc=0;
for iyr=2016:2016  % do 1 year at a time
  for idd=1:5:365
    if idd==1, idd=2; end;
    cc=cc+1;
    YRPLT(cc,1)=iyr;
...
if s_mat==1
  fmat=sprintf('%sarc08_%3.3i_Sfld_lrs_%i.mat',pthmat,expt,yr);
  fprintf('Saving %s\n',fmat);
  save(fmat,'TSFLD');
end
...
fmat1=sprintf('%sarc08_%3.3i_Sfld_lrs_%i.mat',pthmat1,expt1,yr);
fprintf('Loading %s\n',fmat1);
load(fmat1);
S1=TSFLD;
...
fmat2=sprintf('%sarc08_%3.3i_Sfld_lrs_%i.mat',pthmat2,expt2,yr);
fprintf('Loading %s\n',fmat2);
load(fmat2);
S2=TSFLD;
...
%  contour(HH,[0 0],'w','linewidth',1.2);
  ...
  set(chb,'Fontsize',14,'ticklength',0.05);
