...
YRS = [yr1:yr2];
dP = VFWy-mean(VFWy); % FW flux anomaly
figure(1); clf;
axes('Position',[0.1 0.4 0.83 0.45]);
hb = bar(YRS,dP);
...
title('NCEPR DOE 2, Precip anom, km3/yr, 60W-9.4E, 50.4N - 63.8N');

btx = 'prcp_flx_NCEPR.m';
bottom_text(btx,'pwd',1,'position',[0.01 0.3 0.4 0.05]);
