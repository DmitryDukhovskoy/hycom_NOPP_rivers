...
fina = sprintf('%snest_rmu.a',pthin);
finb = sprintf('%snest_rmu.b',pthin);
fouta = sprintf('%snest_rmu_T%2.2i.a',pthout,ntopo2);
foutb = sprintf('%snest_rmu_T%2.2i.b',pthout,ntopo2);
...
fprintf(fid_bout,'Nest Relaxation Mask, ARCc0.08 Topo 11\n');
fprintf(fid_bout,...
