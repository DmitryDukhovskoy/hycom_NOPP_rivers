...
% in greenl04_meanUTS_Zlvls.m
% means u_bar, T_bar, S_bar are taken from 
% greenl04_meanUTS_Zlvls.m
%
...
fprintf('%s-%3.3i Calc daily perturb U,T,S, Greenl Contr, on Z, %i\n',regn,expt,YR1);

pthtopo= '/Net/ocean/ddmitry/HYCOM/ARCc/ARCc0.04/topo_grid/';
pthmat = '/Net/tholia/ddmitry/hycom/ARCc0.04/data_mat2/';
fmatu  = sprintf('%sarc04_expt%3.3i_greenl_contr_mnthUzlv_%i.mat',pthmat,expt,YR1);
fmatt  = sprintf('%sarc04_expt%3.3i_greenl_contr_mnthTzlv_%i.mat',pthmat,expt,YR1);
fmats  = sprintf('%sarc04_expt%3.3i_greenl_contr_mnthSzlv_%i.mat',pthmat,expt,YR1);
fmatup = sprintf('%sarc04_expt%3.3i_greenl_contr_prtrbUzlv_%i.mat',pthmat,expt,YR1);
fmattp = sprintf('%sarc04_expt%3.3i_greenl_contr_prtrbTzlv_%i.mat',pthmat,expt,YR1);
fmatsp = sprintf('%sarc04_expt%3.3i_greenl_contr_prtrbSzlv_%i.mat',pthmat,expt,YR1);
fmatut = sprintf('%sarc04_expt%3.3i_greenl_contr_meanUT_%i.mat',pthmat,expt,YR1);
