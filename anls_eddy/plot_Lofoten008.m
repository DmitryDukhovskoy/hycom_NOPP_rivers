...
zz0   = -1;  %  depth of calculation
%txtb = 'plot_deepU_ssh.m';
btxt = 'plot_Lofoten008.m';

pthmat  = '/Net/mars/ddmitry/hycom/ARCc0.08/data_mat/';
pthtopo = '/Net/ocean/ddmitry/HYCOM/ARCc/ARCc0.08/topo_grid/';
pthfig  = '/Net/ocean/ddmitry/HYCOM/ARCc/ARCc0.08/110/fig_Lofoten/';
...
%    colorbar;
    ...
    stl=sprintf('ARCc0.08-%s, T&U, depth=%5.1fm, %4.4i/%2.2i/%2.2i',expt,zz0,DV(1:3));
    title(stl);

    bottom_text(btxt,'pwd',1,'fontsize',10);
    cnt=cnt+1;
    if s_fig==1
      fgnm = sprintf('%sarc08_110_Lofoten_TU_%4.4i',pthfig,cnt);
      fprintf('Saving %s\n',fgnm);
