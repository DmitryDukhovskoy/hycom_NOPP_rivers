...
fmat   = sprintf('%sncar_rivers_Arctic_1993-2015',pthmat);
load(fmat); % <-- RVR
...
%  Npnts = ceil(log(Qr));
  ...
  Npnts = round(Qrms/0.4e-4); % ~max runoff in a grid cell 
...
% This is for 9-box filter will produce extra "mass"
%    for ii=ii1:ii2
%      for jj=jj1:jj2;
