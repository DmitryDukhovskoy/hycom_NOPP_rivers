...
%HYCOM with Greenland  
  flrivGa=sprintf('%srivers_%2.2i_Greenland_%4.4i.a',PTH.data,ntopo,YearGr); 
  flrivGb=sprintf('%srivers_%2.2i_Greenland_%4.4i.b',PTH.data,ntopo,YearGr);
%  flrivGa=sprintf('%srivers_%2.2i_dummy_%4.4i.a',PTH.data,ntopo,YearGr); 
%  flrivGb=sprintf('%srivers_%2.2i_dummy_%4.4i.b',PTH.data,ntopo,YearGr);
